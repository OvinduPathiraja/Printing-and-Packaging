                ...
                <div class="content-wrapper">
                    ...
                    @endif
                        ...
                        <label>Product Title</label>
                            <input class="text_color" type="text" name="title" placeholder="Write a title" id="" required="" value="{{$product->title}}">
                        </div>
                        <div>
                            <div class="div_design">
                            ...
                            <div class="div_design">
                                ...
                                <input class="text_color" type="number" name="price" placeholder="Write a price" id="" required="" value="{{$product->price}}">
                            </div>
                            <div class="div_design">
                                <label>Product Quantity</label>
                                <input class="text_color" type="number" min="0" name="quantity" placeholder="Write a title" id="" required="" value="{{$product->quantity}}">
                            </div>
                            <div class="div_design">
