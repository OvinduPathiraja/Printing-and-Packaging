        ...
        <div class="site-wrap">
            ...
            <section class="site-section">
                <div class="container">
                    ...
                    @endif
                    <h1 class="h1-font">All quotes</h1>
                    ...
                    <table class="center_table">
                        ...
                        <tr>
                            ...
                            <td>{{$quote->mobile}}</td>
                            <td>
                                <a class="btn btn-danger" onclick="return confirm('Are you sure want to delete')" href="{{url('delete_quote',$quote->id)}}">Delete</a>
                            </td>
                            <td>
                                <a class="btn btn-success" href="{{url('update_quote',$quote->id)}}">Edit</a>
                            </td>
                        </tr>
                        @endforeach
                    </table>
